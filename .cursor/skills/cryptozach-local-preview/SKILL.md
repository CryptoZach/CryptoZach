...
| `/start-here.html` | Overview: definitions, five questions, entry points |
| `/frameworks.html` | Legacy URL: should redirect to `Operating-Model.html` (hash preserved) |
| `/2026-frameworks.html` | Legacy URL: should redirect to `start-here.html` |
