...
| `tao.png` | Bittensor (TAO) (bundled **`build-sources/tao.svg`**: bold **TAO** ticker; Iconify **`token/tao`** hex mark reads as a filled hex at matrix size) |
